...
# Example usage
panoramic_img = cv2.imread(r'D:\ubuntu\test_algorithm\deep_learning\hyp_dataset\hyp_outdoor_3\all_outdoor_3\IMG_0058\frame_01018.jpg')  # Load the panoramic image
