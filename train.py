...
# parser.add_argument('root_dir', default=r'F:\omnimvs_pytorch\datasets\omnithings')
...
def main():
    ...
    train_loader = DataLoader(trainset, args.batch_size, shuffle=True, pin_memory=True)
    val_loader = DataLoader(valset, args.batch_size, shuffle=False, pin_memory=True)

    print(f"args.val_list: {args.val_list}")
    print(f"args.train_list: {args.train_list}")
